...
func (_q *FileQuery) QueryGame() *GameQuery {
...
func (_q *FileQuery) WithGame(opts ...func(*GameQuery)) *FileQuery {
	query := (&GameClient{config: _q.config}).Query()
...
func (_q *FileQuery) loadGame(ctx context.Context, query *GameQuery, nodes []*File, init func(*File), assign func(*File, *Game)) error {
